...
@TeleOp(name = "TeleOp 12384")
public class TeleOp12384 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        boolean intakeRotTog = true, intakeSpinTog = true, intakeStopTog = true, autoScoreToggle = true, intakeReturnToggle = true, scoringOverrideToggle = false;
        int intakeSpinDir = 1;
